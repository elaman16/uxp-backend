...
@Entity
public class UserFunctionalityUsageHistory {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UserFunctionalityUsageHistory other = (UserFunctionalityUsageHistory) obj;
		if (LocId == null) {
			if (other.LocId != null)
				return false;
	...
	public String toString() {
		return "UserFunctionalityUsageHistory [userId=" + userId + ", functionalityId=" + functionalityId
